document.addEventListener("DOMContentLoaded", function () {
  ...
  const userNameSideSpan = document.querySelector(".user-name-span");
  if (userNameSideSpan) {
    userNameSideSpan.textContent = storedUser || "Guest";
  }
  ...
  createPlanBtn.addEventListener("click", function () {
    const bmiCategory = document
      .getElementById("bmi-condition")
      .innerText.trim()
      .toLowerCase();
